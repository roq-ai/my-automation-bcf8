...
export function ActivityLogListPage(props: ActivityLogListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getActivityLogs({
        relations: ['user', 'team', 'project', 'task', 'comment'],
        limit: params.pageSize,
        offset: params.pageNumber * params.pageSize,
        searchTerm: params.searchTerm,
        order: params.order,
        searchTermKeys: ['activity.contains', 'activity_type.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('comment', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          accessorKey: 'comment',
          cell: ({ row: { original: record } }: any) => (
            <Link as={NextLink} onClick={(e) => e.stopPropagation()} href={`/comments/view/${record.comment?.id}`}>
