...
export function TaskListPage(props: TaskListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getTasks({
        relations: ['user', 'project', 'activity_log.count', 'comment.count'],
        limit: params.pageSize,
        offset: params.pageNumber * params.pageSize,
        searchTerm: params.searchTerm,
        order: params.order,
        searchTermKeys: ['name.contains', 'description.contains', 'task_status.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'task_status', header: 'Task Status', accessorKey: 'task_status' },
    {
      id: 'due_date',
      header: 'Due Date',
    ...
    hasAccess('project', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('activity_log', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'activity_log',
          header: 'Activity Log',
          accessorKey: 'activity_log',
          cell: ({ row: { original: record } }: any) => record?._count?.activity_log,
        }
      : null,
