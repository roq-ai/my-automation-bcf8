...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`My automation`}</title>

        <meta
          name="description"
          content="My Automation - Transforming the way you interact with data, bringing simplicity, efficiency, and accuracy to your fingertips. Your ultimate data show application."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1460925895917-afdab827c52f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxkYXRhfGVufDB8fHx8MTY5NTQ1NDM2NXww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`My Automation - Transforming the way you interact with data, bringing simplicity, efficiency, and accuracy to your fingertips. Your ultimate data show application.`}
            </Text>
            <Box
