...
export function TeamListPage(props: TeamListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getTeams({
        relations: ['user', 'activity_log.count', 'project.count'],
        limit: params.pageSize,
        offset: params.pageNumber * params.pageSize,
        searchTerm: params.searchTerm,
        order: params.order,
        searchTermKeys: ['description.contains', 'team_status.contains', 'name.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'team_status', header: 'Team Status', accessorKey: 'team_status' },
